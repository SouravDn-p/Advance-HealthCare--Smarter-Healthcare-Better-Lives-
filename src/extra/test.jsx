...
export default function CreateAuction() {
  ...
  const handleDownloadPDF = () => {
    ...
    setTimeout(() => {
      ...
      doc.setFont("helvetica", "normal");
      doc.text(
        `$${Number.parseFloat(auctionData.startingPrice).toLocaleString(
          "en-US",
          {
      ...
      Swal.fire({
        ...
        <div class="text-center">
          ...
          }">You can use this document for your records or share it with others.</p>
        </div>
      `,
        icon: "success",
        confirmButtonColor: "#9333ea",
  ...
  const handleSubmit = async (e) => {
    ...
    <div class="text-center">
      ...
      <p class="text-sm ${
        isDarkMode ? "text-gray-300" : "text-gray-600"
      }">Would you like to download a PDF copy for your records?</p>
    </div>
  `,
        icon: "success",
      ...
      {dbUser.role == "seller" ? (
        ...
        >
          <div className="container mx-auto px-4">
            <div
              className={`max-w-4xl p-6 md:p-8 mx-auto rounded-xl  ${
                isDarkMode ? "" : ""
              }`}
            >
                ...
                >
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex">
                            ...
                            <span>
                              {auctionData.startTime.toLocaleString()}
                            </span>
                          </div>
                          <div className="flex">
                            <span
                  ...
                  {selectedImages.length < 4 && (
                    ...
                    >
                      ...
                      <p className="text-sm">
                        Please upload at least 4 images to complete your auction
                        listing.
                      </p>
                    </div>
                  )}
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div className="space-y-6">
                    <div className="space-y-1">
                      ...
                      >
                        <FaCamera className="text-xs" /> Upload Images (Minimum
                        4 required)
                      </label>
                      <label
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700 gap-4">
                  <div className="flex items-center">
                    ...
                    />
                    <p className="text-sm">
                      Your auction will be reviewed by our team before going
                      live
                    </p>
                  </div>
