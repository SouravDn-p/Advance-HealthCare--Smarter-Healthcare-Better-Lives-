...
const ContactUs = () => {
  ...
  // Healthcare-related partner logos (using placeholders for now)
  const partners = [
    {
      name: "HealthCorp",
              ...
              {isSubmitting ? (
                ...
                <>
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M10.293 5.293a1 *M11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                      clipRule="evenodd"
                    />
                  </svg>
                </>
